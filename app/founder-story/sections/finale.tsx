...
const communityCards = [
  ...
  { title: "Build", description: "Start using Rithm UI in your projects today.", icon: Code2 },
]
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-12">
            <div className="flex flex-col items-center space-y-4">
              <span className="text-2xl tracking-widest uppercase font-bold text-neutral-900 dark:text-white">Rithm UI</span>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <a href="https://github.com/aadiexii/Rithm-UI" className="px-8 py-4 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black text-neutral-900 dark:text-white font-medium hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors duration-300">
                Support the Project
              </a>
            </div>
          </div>
