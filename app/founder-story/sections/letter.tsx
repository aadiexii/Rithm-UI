  ...
  return (
    <section ref={containerRef} className="py-32 w-full max-w-4xl mx-auto flex flex-col items-center">
      ...
      >
        ...
        <p>
          Rithm UI exists because developers deserve better defaults.
        </p>
        <p>
      ...
      >
        <div className="flex flex-col items-end space-y-1">
           <span className="font-serif italic text-3xl text-neutral-900 dark:text-white">Shivam</span>
           <span className="text-sm font-medium tracking-widest uppercase text-neutral-400">Founder, Rithm UI</span>
        </div>
      </motion.div>
    </section>
  )
