...
const steps = [
  ...
  { name: "Rithm UI", subtitle: "Build once. Reuse forever." },
]
          ...
          {step === 6 && (
            ...
            >
              ...
              >
                ...
                <h3 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white relative z-10">Rithm UI</h3>
