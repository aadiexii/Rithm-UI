...
export const metadata: Metadata = baseMetadata({
  ...
  canonicalUrl: "https://rithmui.com/docs/dual-range-slider",
});
...
const DualRangeSliderPage = () => {
  return (
    <SEOWrapper
      ...
      url="https://rithmui.com/docs/dual-range-slider"
      keywords={[
        "dual range slider",
        "range slider",
        "React range slider",
    ...
    >
      <PreviewCodeCard
        ...
        cli="@rithmui/dual-range-slider-demo"
      ...
      <Usage
        ...
        cli="@rithmui/dual-range-slider-custom-label"
      >
      ...
      <Usage
        ...
        cli="@rithmui/dual-range-slider-label-position"
      >
      ...
      <Usage
        ...
        cli="@rithmui/dual-range-slider-single"
      >
